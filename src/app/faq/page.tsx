...
export default function FAQ() {
  return (
    <>
      <SEOHead
        title="FAQ | BYK Oxford"
        description="Find answers to common questions about our financial modelling services, implementation support, and how we work with clients."
        url="https://bykoxford.com/faq"
