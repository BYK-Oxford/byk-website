export default function CEO() {
  return (
    ...
    //             <p>
    //               Building this company has been one of the most rewarding
    //               journeys of my life. Every challenge has taught me the value
    //               of resilience, and every success has reminded me that real
    //               progress comes from people — the ones we work with and the
    //               ones we serve. I'm proud of what we've achieved, and even more
    //               excited about where we're headed.
    //             </p>
    //           </blockquote>
    //           <figcaption className="mt-8 text-base">
    //             <div className="font-semibold text-white">Burak Yilmazkaya</div>
    //             <div className="mt-1 text-gray-400">CEO of BYK Oxford</div>
    //           </figcaption>
    //         </figure>
    //       </div>
    //     </div>
