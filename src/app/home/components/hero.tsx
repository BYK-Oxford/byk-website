            ...
            <div className="mt-5 flex justify-end gap-8 sm:-mt-10 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              ...
              <div className="w-40 flex-none space-y-8 pt-32 sm:pt-0">
                ...
                >
                  <Image
                    alt=""
                    src="https://images.unsplash.com/photo-1686578722643-694ce4595b44?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    className="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                    width={768}
                    height={528}
                  />
