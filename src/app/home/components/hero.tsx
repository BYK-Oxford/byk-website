              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <div className="flex flex-col gap-8">
                    <h1 className="text-6xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-6xl">
                      Precision Accounting for Your Business Growth
                    </h1>
                    <p className="text-lg font-medium text-pretty text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
