...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/manish10gurung@gmail.com", {
        method: "POST",
        body: formData,
      });
...
export default function Contact() {
  ...
  return (
        ...
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
               Have questions or need tailored financial solutions? Our team is here to help. Reach out to discover how we can support your business growth and clarity.
            </p>
            <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:burry.yilmazkaya@bykoxford.com" className="hover:text-gray-900">
    ...
    > {/* Hidden fields for FormSubmit */}
            ...
            <input type="hidden" name="_subject" value="New Mail From BYK Oxford Website!" />
